    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Administrateur', 'Administrateur'), ('Gestionnaire', 'Gestionnaire'), ('Agent de terrain', 'Agent de terrain'), ('Comptable', 'Comptable')], max_length=30)),
